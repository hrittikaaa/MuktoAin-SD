...
- [x] ~~**[A-1.1]** All DTOs in `MuktoAin.Application/DTOs/` — *Arpita* `[Blocked by: H-1.2, H-1.3] [Unblocks: A-2.1]`~~
...
- [x] ~~**[H-1.9]** Legal Section Chunking Pipeline (`LegalChunkingService.cs`) — *Hrittika* `[Blocked by: H-1.8] [Unblocks: S-1.8]`~~
